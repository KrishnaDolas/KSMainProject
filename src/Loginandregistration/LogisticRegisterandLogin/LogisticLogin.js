...
import verImage from "../../Assets/Background/LogisticsLogo.png";
import { toast, ToastContainer } from "react-toastify";
import "react-toastify/dist/ReactToastify.css";
import useAuthOperationAdmin from "../../Roles/Logistic/Auth/AuthContext";
        ...
        try {
            if (activeStep === 0) {
                ...
                const response = await axios.post(
                    `${process.env.REACT_APP_API_URL}/api/logistic-member/sendLoginPassword`,
                ...
                // Perform login
                const response = await axios.post(
                    `${process.env.REACT_APP_API_URL}/api/logistic-member/login`,
