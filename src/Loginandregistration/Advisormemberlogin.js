...
import verImage from "../Assets/Background/Loginimg.png";
import { toast, ToastContainer } from "react-toastify";
import "react-toastify/dist/ReactToastify.css";
import useAuthAdvisory from "../Roles/Advisor/AdvisorMember/Auth/AuthContext";
import logoSrc from '../Assets/Logo/KStarLogo.png'

const steps = ["Enter Email", "Enter Password"];

const Advisormemberlogin = () => {
    useAuthAdvisory();
        ...
        try {
            if (activeStep === 0) {
                ...
                const response = await axios.post(
                    `${process.env.REACT_APP_API_URL}/api/advisory-member/send-password`,
                    { officialEmail: email }
                );
                ...
                // Perform login
                const response = await axios.post(
                    `${process.env.REACT_APP_API_URL}/api/advisory-member/login`,
...
export default Advisormemberlogin;