...
import verImage from "../../Assets/Background/VA.png";
import { toast, ToastContainer } from "react-toastify";
import "react-toastify/dist/ReactToastify.css";
import useAuthVendorAdmin from "../../Roles/Vendor/VendorAdmin/Auth/AuthContext";
import logoSrc from '../../Assets/Logo/KStarLogo.png'

const steps = ["Enter Email", "Enter Password"];

const VendorAdminLogin = () => {
    useAuthVendorAdmin();
        ...
        try {
            if (activeStep === 0) {
                ...
                const response = await axios.post(
                    `${process.env.REACT_APP_API_URL}/api/vendor-admin/send-password`,
                    { officialEmail: email }
                );
                ...
                // Perform login
                const response = await axios.post(
                    `${process.env.REACT_APP_API_URL}/api/vendor-admin/login`,
