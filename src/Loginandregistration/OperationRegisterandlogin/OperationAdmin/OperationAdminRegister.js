...
const OperationAdminRegister = () => {
  ...
  const handleDobChange = (e) => {
    ...
    let calculatedAge = age; // Use a new variable to avoid confusion
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${process.env.REACT_APP_API_URL}/api/operational-admin/registerOperationalAdmin`,
        {
          employmentId,
          fullName,
          dob,
        ...
        <div className="col-md-6">
          <div className="card">
            <div className="card-header text-center">
              <h4>Operation Admin Register</h4>
            </div>
...
export default OperationAdminRegister;