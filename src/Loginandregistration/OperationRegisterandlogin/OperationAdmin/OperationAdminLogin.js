...
import verImage from "../../../Assets/Background/OA.png";
import { toast, ToastContainer } from "react-toastify";
import "react-toastify/dist/ReactToastify.css";
import useAuthOperationAdmin from "../../../Roles/Operations/Operation Admin/Auth/AuthContext";
import logoSrc from '../../../Assets/Logo/KStarLogo.png'

const steps = ["Enter Email", "Enter Password"];

const OperationAdminLogin = () => {
    useAuthOperationAdmin();
        ...
        try {
            if (activeStep === 0) {
                ...
                const response = await axios.post(
                    `${process.env.REACT_APP_API_URL}/api/operational-admin/sendLoginPassword`,
                    { officialEmail: email } // Send email in the request body
                );
...
export default OperationAdminLogin;