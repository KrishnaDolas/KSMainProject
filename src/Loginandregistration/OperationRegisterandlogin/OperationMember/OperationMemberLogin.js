...
import verImage from "../../../Assets/Background/OM.png";
import { toast, ToastContainer } from "react-toastify";
import "react-toastify/dist/ReactToastify.css";
import useAuthOperationMember from "../../../Roles/Operations/Operation Member/Auth/AuthContext";
import logoSrc from '../../../Assets/Logo/KStarLogo.png'

const steps = ["Enter Email", "Enter Password"];

const OperationMemberLogin = () => {
    useAuthOperationMember();
        ...
        try {
            if (activeStep === 0) {
                ...
                const response = await axios.post(
                    `${process.env.REACT_APP_API_URL}/api/operational-member/sendLoginPassword`,
                    { officialEmail: email }
                );
                ...
                // Perform login
                const response = await axios.post(
                    `${process.env.REACT_APP_API_URL}/api/operational-member/login`,
                ...
                if (response.data.token) {
                    ...
                    toast.success(response.data.message);
                    navigate("/OperationMemberDashboard");
                }
            }
        } catch (error) {
...
export default OperationMemberLogin;