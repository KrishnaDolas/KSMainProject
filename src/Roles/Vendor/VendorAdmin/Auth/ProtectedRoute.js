...
const ProtectedRouteVendorAdmin = ({ children, isLoggedIn, setIsLoggedIn }) => {
    ...
    useEffect(() => {
        const checkAuth = async () => {
            try {
                await axios.get(`${process.env.REACT_APP_API_URL}/api/vendor-admin/dashboard`, {
                ...
                navigate('/VendorAdminLogin'); // Navigate immediately after state update
            }
        };
...
export default ProtectedRouteVendorAdmin;
