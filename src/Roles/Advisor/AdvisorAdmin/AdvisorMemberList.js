    ...
    const fetchAdvisories = async () => {
      try {
        const response = await axios.get(
          `${process.env.REACT_APP_API_URL}/api/advisory-admin/advisory-members`,
          { withCredentials: true }
        );
        setAdvisories(response.data.advisoryMembers);
      } catch (error) {
...
export default AdvisorMemberList;
