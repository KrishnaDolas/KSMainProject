...
function ToggleLogin() {
  ...
  const toggleLoginStatus = async () => {
    ...
    try {
      await axios.patch(
        `${process.env.REACT_APP_API_URL}/api/advisory-admin/advisory-members/toggle-login/${customerId}`,
        {},
        { withCredentials: true }
      );
      toast.success("Login status toggled successfully.");
      navigate("/AdvisorMemberList");
    } catch (error) {
      ...
      <div style={containerStyle}>
        <div style={boxStyle}>
          ...
          <p style={descriptionStyle}>
            Use the toggle switch below to enable or disable login for this advisory member.
          </p>
