...
import AdvisorMemberNavbar from './LogisticNavbar';
...
export default function Sidebar({ children }) {
  ...
  const menuItems = [
    { text: 'Dashboard', icon: <HomeIcon />, link: '/LogisticDashboard' },
    { text: 'Confirm Orders', icon: <AddIcon />, link: '/LogisticConfirmOrders' }, // Using Plus icon
