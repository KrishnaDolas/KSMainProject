...
const Calendar = ({ onDateSelect }) => {
    ...
    const [isSelectingEndDate, setIsSelectingEndDate] = useState(false); // Flag to track if selecting end date
    ...
    const handleDateClick = ({ dateStr }) => {
        ...
        if (!startDate) {
            ...
            onDateSelect(startDate, dateStr); // Send both dates back to the parent
